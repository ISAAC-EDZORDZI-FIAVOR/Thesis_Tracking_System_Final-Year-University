...
$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_one c JOIN users u ON c.student_id = u.id WHERE u.department_id = ?");
$stmt->execute([$department_id]);
$totalchapter_oneSubmitted = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_one c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'pending'");
$stmt->execute([$department_id]);
$totalchapter_oneSubmittedPending = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_one c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'approved'");
$stmt->execute([$department_id]);
$totalchapter_oneSubmittedApproved = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_one c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'rejected'");
$stmt->execute([$department_id]);
$totalchapter_oneSubmittedRejected = $stmt->fetchColumn();

// Thesis chapter Two query in the dashboard
$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_two c JOIN users u ON c.student_id = u.id WHERE u.department_id = ?");
$stmt->execute([$department_id]);
$totalchapter_twoSubmitted = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_two c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'pending'");
$stmt->execute([$department_id]);
$totalchapter_twoSubmittedPending = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_two c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'approved'");
$stmt->execute([$department_id]);
$totalchapter_twoSubmittedApproved = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_two c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'rejected'");
$stmt->execute([$department_id]);
$totalchapter_twoSubmittedRejected = $stmt->fetchColumn();

// Thesis chapter Three query in the dashboard
$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_three c JOIN users u ON c.student_id = u.id WHERE u.department_id = ?");
$stmt->execute([$department_id]);
$totalchapter_threeSubmitted = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_three c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'pending'");
$stmt->execute([$department_id]);
$totalchapter_threeSubmittedPending = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_three c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'approved'");
$stmt->execute([$department_id]);
$totalchapter_threeSubmittedApproved = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_three c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'rejected'");
$stmt->execute([$department_id]);
$totalchapter_threeSubmittedRejected = $stmt->fetchColumn();

// Thesis chapter Four query in the dashboard
$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_four c JOIN users u ON c.student_id = u.id WHERE u.department_id = ?");
$stmt->execute([$department_id]);
$totalchapter_fourSubmitted = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_four c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'pending'");
$stmt->execute([$department_id]);
$totalchapter_fourSubmittedPending = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_four c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'approved'");
$stmt->execute([$department_id]);
$totalchapter_fourSubmittedApproved = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_four c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'rejected'");
$stmt->execute([$department_id]);
$totalchapter_fourSubmittedRejected = $stmt->fetchColumn();

// Thesis chapter Five query in the dashboard
$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_five c JOIN users u ON c.student_id = u.id WHERE u.department_id = ?");
$stmt->execute([$department_id]);
$totalchapter_fiveSubmitted = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_five c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'pending'");
$stmt->execute([$department_id]);
$totalchapter_fiveSubmittedPending = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_five c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'approved'");
$stmt->execute([$department_id]);
$totalchapter_fiveSubmittedApproved = $stmt->fetchColumn();

$stmt = $pdo->prepare("SELECT COUNT(*) FROM chapter_five c JOIN users u ON c.student_id = u.id WHERE u.department_id = ? AND c.status = 'rejected'");
$stmt->execute([$department_id]);
