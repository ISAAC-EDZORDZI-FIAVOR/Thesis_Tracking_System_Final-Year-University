...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Fetch the assigned lecturer_id for this student
    ...
    if ($assignment) {
        ...
        $stmt = $pdo->prepare("INSERT INTO thesis_proposals (student_id, lecturer_id, title, description, status) VALUES (?, ?, ?, ?, 'pending')");
        $stmt->execute([$student_id, $lecturer_id, $title, $description]);
