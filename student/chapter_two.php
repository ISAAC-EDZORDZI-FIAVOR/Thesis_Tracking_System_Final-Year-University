...
$stmt = $pdo->prepare("SELECT * FROM chapter_two WHERE student_id = ?");
$stmt->execute([$student_id]);
$chapter_two = $stmt->fetch(PDO::FETCH_ASSOC);
                                                            ...
                                                            <?php else: ?>
                                                                <?php if (!$chapter_two): ?>
                                                                    ...
                                                                    <div class="col-md-12 col-sm-12 col-12 text-center">
                                                                        <a id="btn-add-notes" class="btn btn-primary" href="javascript:void(0);">Submit Your Chapter Two</a>
                                                                        ...
                                                                        <div class="card mt-4">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="alert alert-info" role="alert">
                                                                                    Your Chapter Two is Pending Approval.
                                                                                </div>
                                                                                <ul class="list-group">
                                                                                    <li class="list-group-item list-group-item-primary"><strong>Title:</strong> <?php echo htmlspecialchars($chapter_two['title']); ?></li>
                                                                                    <li class="list-group-item list-group-item-primary"><strong>Description:</strong> <?php echo htmlspecialchars($chapter_two['description']); ?></li>
                                                                                    <li class="list-group-item list-group-item-primary"><strong>Status:</strong> <span class="badge bg-warning text-dark"><?php echo ucfirst( htmlspecialchars($chapter_two['status'])); ?></span></li>
                                                                                    <li class="list-group-item list-group-item-primary"><strong>Submitted Date:</strong> <?php echo date('F j, Y, g:i a', strtotime($chapter_two['submission_date'])); ?></li>
                                                                                </ul>

                                                                                <?php if (!empty($chapter_two['file_path'])): ?>
                                                                                    <div class="card mt-4">
                                                                                        <div class="card-header bg-primary text-white">
                                                                                            <h5 class="mb-0">Chapter Two Document</h5>
                                                                                        </div>
                                                                                        <div class="card-body">
                                                                                            <p>View the Chapter Two document: <a href="../lecturer/<?php echo $chapter_two['file_path']; ?>" target="_blank" class="btn btn-sm btn-outline-primary"><i class="fas fa-file-pdf"></i> Open PDF</a></p>
                                                                                        </div>
                                                                                    </div>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                    ...
                                                                    <?php elseif ($chapter_two['status'] == 'rejected'): ?>
                                                                            <div class="card mt-4">
                                                                                ...
                                                                                <div class="card-body">
                                                                                    <div class="alert alert-danger" role="alert">
                                                                                        Your Chapter Two Submission has been Rejected. Please Review the Feedback and Resubmit.
                                                                                    </div>
                                                                                    <ul class="list-group">
                                                                                ...
                                                                                <div class="card mt-4">
                                                                                    ...
                                                                                    <div class="card-body">
                                                                                        ...
                                                                                        <div class="d-grid gap-2">
                                                                                            <a href="chapter_three.php" class="btn btn-primary">
                                                                                                Submit Chapter Three <i class="fas fa-arrow-right"></i>
                                                                                            </a>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title add-title" id="notesMailModalTitleeLabel">Submit Chapter Two</h5>
                                                                ...
                                                                <div class="notes-box">
                                                                    ...
                                                                    <form method="post" action="" id="notesMailModalTitle" enctype="multipart/form-data"> 
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="chapter_file">Upload Chapter Two (PDF only)</label>
...
if (isset($_POST['submit_Chapter'])) {
    ...
    if ($assignment) {
        ...
        if (!empty($_FILES['chapter_file']['name'])) {
            ...
            $fileName = $_SESSION['username'] . '_' . str_replace(' ', '_', $_SESSION['fullname']) . '_chapter_two.pdf';
            $uploadPath = '../uploads/Chapter_Two/' . $fileName;
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO chapter_two
            ...
            $fetch_id_stmt = $pdo->prepare("SELECT id FROM chapter_two WHERE student_id = ? ORDER BY submission_date DESC LIMIT 1");
            $fetch_id_stmt->execute([$student_id]);
            $chapter_two_id = $fetch_id_stmt->fetchColumn();

            $stmt = $pdo->prepare("INSERT INTO chapter_two_interactions (chapter_two_id, user_id, title, description, message) VALUES (?, ?, ?, ?, ?)");
            $stmt->execute([$chapter_two_id, $student_id, $title, $description, "Sir Please I have Submitted Chapter Two"]);

            $pdo->commit();

                ?>
            <script>
                swal("Thesis Tracking System.", "Chapter Two Submitted Successfully !!", "success");
                            setTimeout(function() {
                window.location.href = "chapter_two.php";
            },1000);
            </script>
           <?php
