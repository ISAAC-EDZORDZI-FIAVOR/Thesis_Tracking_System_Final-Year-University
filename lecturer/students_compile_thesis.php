...
$query = "SELECT DISTINCT u.id, u.fullname, u.username, u.email, u.student_level, 
          ...
          LEFT JOIN compiled_thesis tp ON u.id = tp.student_id
                                    ...
                                    <?php foreach ($result as $row): ?>
                                        <div class="items">
                                            <div class="item-content">
                                                ...
                                                <div class="action-btn">
                                                <a href="view_student_compile_thesis.php?student_id=<?php echo $row['id']; ?>" class="btn btn-outline-primary view-btn">View Compiled Thesis</a>
