                                ...
                                <?php foreach ($chapter_two as $chapter): ?>
                                    <div class="card mb-4 proposal-card">
                                        <div class="card-header bg-primary text-white">
                                            <h1 class="card-title text-white h5 mb-0 text-center"><?php echo htmlspecialchars($chapter['title']); ?></h1>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <?php if (!empty($chapter['file_path'])): ?>
                                                <div class="card mt-4">
                                                    <div class="card-header bg-primary text-white">
                                                        <h5 class="mb-0 text-white"><i class="fas fa-file-pdf"></i> Chapter Two Document</h5>
                                                    </div>
                                                    <div class="card-body">
